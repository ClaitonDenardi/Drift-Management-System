    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Visualização da Corrida</h4>
            </div>
            <div class="row modal-body">
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <label for="visualizacao_piloto_genero">Gênero</label>
                ...
                <div class="col-md-6">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <t:input-text type="text" id="visualizacao_corrida_titulo" name="titulo" label="Título" placeholder="Título da corrida"></t:input-text>
                            <t:input-date tipo="date" id="visualizacao_corrida_data" name="data" label="Data" placeholder="Selecione a data"></t:input-date>
                            <div class="form-group">
                                <label for="visualizacao_corrida_inicio">Horário</label>
                                <div class="row">
                                    <div class="col-xs-6">
                                        <div class="input-group date timepickercustom">
                                            <input type='text' id="visualizacao_corrida_inicio" name="inicio" placeholder="Início" class="form-control timeinput" required />
                            ...
                            <t:input-text type="number" id="visualizacao_corrida_pontos" name="pontos" label="Pontos" placeholder="Pontuação" extra="min='0'"></t:input-text>
                        </div>
                    </div>
                </div>
                </form>
